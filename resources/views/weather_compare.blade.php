        ...
        <section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
            <div class="container">
                ...
                <div class="dashboard-header_conatiner fl-wrap dashboard-header_title">
                    <h1><span>Weather Compare</span></h1>
                </div>
            </div>
        ...
        <section class="gray-bg main-dashboard-sec" id="sec1">
            <div class="container">
                ...
                <table>
					...
					<tr>
						<td width="100%"><div id="sunny"></div></td>
					</tr>
					<tr>
						<td width="100%"><div id="pie1"></div></td>    
					</tr>
					<tr>
						<td width="100%"><div id="rain"></div></td>
					</tr>
					<tr>
						<td width="100%"><div id="july"></div></td>
					</tr>
					<tr>
						<td width="100%"><div id="snow"></div></td>
					</tr>
					<tr>
						<td width="100%"><div id="jan"></div></td>
					</tr>
				</table>
				</div>
                        ...
                        <div class="dashboard-list fl-wrap">
                          ...
                          <thead>
                             <tr>
                               ...
                               <th width="5%">Sunny</th>
                               <th width="5%">Precipitation</th>
                               <th width="5%">Rainfall</th>
                               <th width="5%">Snowfall</th>
                               <th width="5%">Avg July High</th>
                               <th width="5%">Avg. Jan Low</th>
