        ...
        <section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
            <div class="container">
                ...
                <div class="dashboard-header_conatiner fl-wrap dashboard-header_title">
                    <h1><span>Politics Compare</span></h1>
                </div>
            </div>
        ...
        <section class="gray-bg main-dashboard-sec" id="sec1">
            <div class="container">
                ...
                <!-- dashboard content-->
								...
								<tr>
									<td width="100%"><div id="dem"></div></td>
								</tr>
								<tr>
									<td width="100%"><div id="rep"></div></td>
								</tr>
								<tr>
									<td width="100%"><div id="inde"></div></td>
								</tr>
								</table>
								</div>
                        ...
                        <div class="dashboard-list fl-wrap">
                          ...
                          <thead>
                             <tr>
                               ...
                               <th width="10%">Democrats</th>
                               <th width="10%">Republicans</th>
                               <th width="10%">Independents/Others</th>
