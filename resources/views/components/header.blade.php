...
<html lang="en">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWFCuljIcioW3cXqjsrunpEubiLE5raMI&callback=initialize&libraries=&v=weekly" async></script>
         ...
         <div id="main">
            ...
            <header class="main-header">
                ...
                <div class="header-user-menu">
                    <div class="header-search_btn show-search-button"><i class="fal fa-search" style="color: white !important;"></i><span>Search</span></div>
                    <div class="header-user-name btn-primary">
                            @if(session('logged_in') != null)
                                Hello , {{ session("first_name") }}
                            @else
                                <p style="margin-left: 20px;">Log in</p>
                            @endif
                    </div>
                    <ul>
                        @if(session('logged_in') == null)
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Find Places</a>
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item compare_tool_item" id="city_compare" data-toggle="modal" data-target="#compareModal" href="#"  style="color: #697891;">City Compare</a>
                                    <a class="dropdown-item compare_tool_item" data-toggle="modal" data-target="#compareModal" id="cost_living" href="#"  style="color: #697891;">Cost Of Living</a>
                                    <a class="dropdown-item compare_tool_item" data-toggle="modal" data-target="#compareModal" id="crime_compare" href="#"  style="color: #697891;">Crime Compare</a>
                                    <a class="dropdown-item compare_tool_item" data-toggle="modal" data-target="#compareModal" id="politics_compare" href="#"  style="color: #697891;">Politics Compare</a>
                                    <a class="dropdown-item compare_tool_item" data-toggle="modal" data-target="#compareModal" id="weather_compare" href="#"  style="color: #697891;">Weather Compare</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Find Homes</a>
                                <div class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Find Schools</a>
                                <div class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="/find_hotels">Find Accommodations</a>
                            </li>
                            
                           
                            <li class="nav-item">
                                <a href="https://blog.hotciti.com">Blog</a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="forum_open" id="https://discord.gg/nYS6FSXN" data-toggle="modal" data-target="#iframeModal">Forum</a>
                            </li>
                            <!-- <li class="nav-item">
