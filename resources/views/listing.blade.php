    ...
    <div class="content">
        ...
        <div class="col-list-wrap novis_to-top">
            ...
            <div class="listsearch-input-wrap lws_mobile fl-wrap tabs-act" id="lisfw">
                ...
                <div class="clearfix"></div>
                <div class="container" id="sticky_search_container">
                    <!--tabs -->
                    <div class="tabs-container fl-wrap">
                        ...
                        <div class="tab">
                          ...
                          <ul class="nav nav-tabs">
                            <li class="nav-item">
                              <a class="nav-link active map-tab-links" data-toggle="tab" href="#population">Population</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link map-tab-links" data-toggle="tab" href="#geography">Geography</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link map-tab-links" data-toggle="tab" href="#sliders">Topical sliders</a>
                            </li>
                          ...
                          <div class="tab-content" style="display: block !important">
                            <div id="population" class="container tab-pane active"><br/>
                              <br/>
                              <p style="text-align: left;">Narrow your search by entering the desired population. The "from" and "to" fields indicate the beginning and end of the range you want. For example, from 1000 people to 5000 people. Note, do not enter commas.</p>
                              <br/>
                              <div class="row">
                            ...
                            <div id="geography" class="container tab-pane fade"><br>
                              <br/>
                              <p style="text-align: left;">Narrow your search by entering detailed geographic information. You can enter a zipcode or city to view a specific location or you can view more locations by selecting a larger area such as a region, state, or county. You can even enter the nearest city and it will show all the towns within 20 miles. </p>
                              <br/>
                              <div class="row">
                                  <input type="hidden" name="hidden_multi_state" id="hidden_multi_state">
                                  <input type="hidden" name="search_focus3" id="search_focus3" value="{{ $search_box_array[2] }}">
                                  <div class="col-md-12">
                                    
                                    <select id="multi-select" class="selectpicker" multiple data-live-search="true">
                                  ...
                                  <div class="col-md-6" style="margin-top: 20px;">
                                      <div class="listsearch-input-item">
                                          <span class="iconn-dec"><i class="far fa-bookmark"></i></span>
                                              <input type="text" list="data1" id="search_focus1" name="search_focus1" placeholder="City" />
                                  ...
                                  <div class="col-md-6" style="margin-top: 20px;">
                                      <div class="listsearch-input-item">
                                          <span class="iconn-dec"><i class="far fa-bookmark"></i></span>
                                              <input type="text" id="search_focus2" name="search_focus2" placeholder="Zip Code" />
                                      </div>
                                  </div>
                                  <!-- listsearch-input-item end-->
                                  ...
                                  <div class="col-md-4">
                                    <div class="listsearch-input-item">
                                         <span class="iconn-dec"><i class="far fa-bookmark"></i></span>
                                            ...
                                            <input type="text" list="data4" id="search_focus4" value="{{ $search_box_array[1] }}" name="search_focus4" placeholder="Region " />
                                           <datalist id="data4" name="data4" >
                                  ...
                                  <div class="col-md-4">
                                    <div class="listsearch-input-item">
                                         <span class="iconn-dec"><i class="far fa-bookmark"></i></span>
                                          <input type="text" list="data5" id="search_focus5" value="{{ $search_box_array[0] }}" name="search_focus5" placeholder="County" />
                                           <datalist id="data5" name="data5" >
                                   ...
                                   <div class="col-md-4">
                                    <div class="listsearch-input-item">
                                     <span class="iconn-dec"><i class="far fa-bookmark"></i></span>
                                        <input type="text" list="data7" id="search_focus7" name="search_focus7" placeholder="Nearest City" />
                                       <datalist id="data7" name="data7" >
                            ...
                            <div id="sliders" class="container tab-pane fade"><br>
                              <br/>
                              <p style="text-align: left;">Topical sliders are designed to help you narrow your search based on the topics that are important to you. Simply adjust the sliders and watch your search results narrow. </p>
                              <br/>
                              <div class="row">
...
<script>
  ...
  function view_multi_map(){
    ...
    $.ajax({
      ...
      success:function(res_data)
      {
        ...
        function locationData(locationURL, locationImg, locationTitle, locationAddress, locationCategory, locationStatus, locationStateAbb) {
          return ('<div class="map-popup-wrap"><div class="map-popup"><div class="infoBox-close"><i class="fal fa-times"></i></div><a href="singlelisting?ID='+locationURL+'" class="listing-img-content fl-wrap"><div class="infobox-status '+ locationStatus +'">' + locationStatus + '</div><img src="' + locationImg + '" alt="" target="_blank"><div class="card-popup-raining map-card-rainting" data-staRrating="' + ' ' + '"><span class="map-popup-reviews-count"> ' + ' ' + ' </span></div></a> <div class="listing-content"><div class="listing-content-item fl-wrap"><a href="/find_homes_rent?location='+locationTitle+' '+locationAddress+'" data-toggle="tooltip" data-placement="top" title="Homes For Rent" target="_blank"><div class="map-popup-location-category cafe-cat" style="right: 145px;"><i class="fas fa-home" style="color:white;margin-top:10px;font-size: 20px;"></i></div></a><a href="/find_homes?location='+locationTitle+' '+locationAddress+'" data-toggle="tooltip" data-placement="top" title="Homes For Sale" target="_blank"><div class="map-popup-location-category cafe-cat" style="right: 80px;"><i class="fas fa-home" style="color:white;margin-top:10px;font-size: 20px;"></i></div></a><a href="/find_schools?location='+ locationTitle +' '+ locationStateAbb +'" target="_blank"><div class="map-popup-location-category cafe-cat"><i class="fas fa-school" style="color:white;margin-top:10px;font-size: 20px;"></i></div></a><div class="listing-title fl-wrap"><h4><a href="singlelisting?ID='+locationURL+'" target="_blank">' + locationTitle + '</a></h4><div class="map-popup-location-info"><i class="fas fa-map-marker-alt"></i>' + locationAddress + '</div></div><div class="map-popup-footer"><a href="singlelisting?ID='+locationURL+'" class="main-link" target="_blank">Details <i class="fal fa-long-arrow-right"></i></a></div></div></div></div>')
      }
        var map = new google.maps.Map(document.getElementById('map-main'), {
          zoom: 3,
          scrollwheel: false,
  ...
  function set_li_function(){
    $("#geography div div.col-md-12 div div div.inner.show ul li a").attr("onclick", "multi_state_select()");
  }
