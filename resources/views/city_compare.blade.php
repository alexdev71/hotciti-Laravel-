...
<div id="wrapper">
    ...
    <div class="content">
        ...
        <section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
            <div class="container">
                <div class="dashboard-breadcrumbs breadcrumbs"><a href="/">Home</a><a href="#" data-toggle="modal" data-target="#compareModal">Dashboard</a><span>Compare</span></div>
            </div>
                ...
                <!-- dashboard content-->
                                ...
                                <div style="overflow-x:auto;">
	                                <div class="big-container">
										<div class="row">
											<div class="col-lg-6"><div id="price1"></div></div>
											<div class="col-lg-6"><div id="price2"></div></div>
										</div>                                              
										<div class="row">
											<div class="col-lg-6"><div id="container1"></div></div>
											<div class="col-lg-6"><div id="container2"></div></div>
										</div>
										<div class="row">
											<div class="col-lg-6"><div id="single1"></div></div>
											<div class="col-lg-6"><div id="single2"></div></div>
										</div>
										<div class="row">
											<div class="col-lg-6"><div id="line1"></div></div>
											<div class="col-lg-6"><div id="line2"></div></div>
										</div>
										<div class="row">
											<div class="col-lg-6"><div id="pie1"></div></div>
											<div class="col-lg-6"><div id="dnut"></div></div>
										</div>
										<div class="row">
											<div class="col-lg-6"><div id="round"></div></div>
											<div class="col-lg-6"><div id="round1"></div></div>
										</div>
									</div>
								</div>
                                                ...
                                                <div style="overflow-x:auto;">     
                    		                        <table id="userTable" border="1" >
                    			                        <thead>
                    			                            ...
                    			                            <th width="5%">Median Income</th>
                    			                            <th width="5%">Median Age</th>
                    			                            <th width="5%">Avg. Home Price</th>
                    			                            <th width="5%">Unemployment Rate</th>
                    			                            <th width="5%">Commute Time</th>
                    			                            <th width="5%">Sunny Days</th>
                    			                            <th width="7%">Violent Crime</th>
                    			                            </tr>
                    			                        </thead>
                    			                        <tbody></tbody>
                    		                        </table>
