...
function initTowhub() {
 ...
 // date picker------------------
    ...
    $("#subscribe").ajaxChimp({
        language: "eng",
        url: "https://hotciti.us7.list-manage.com/subscribe/post?u=b526ef8d53e1fb7ad6fc843a4&amp;id=46035d5532"
    });
 ...
 // scroll animation ------------------
    ...
    var modal = {};
    modal.hide = function () {
        $('.modal1 , .reg-overlay').fadeOut(200);
        $("html, body").removeClass("hid-body");
        $(".modal_main").removeClass("vis_mr");
    };
    $('.modal-open').on("click", function (e) {
        e.preventDefault();
        $('.modal1 , .reg-overlay').fadeIn(200);
